  ...
  return (
    <div className="relative">
      ...
      <div className="relative  flex gap-1 flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row">
        {/* TEXT CONTAINER */}
        <div className="flex flex-1 items-center justify-center flex-col gap-8 font-extrabold text-white relative">
          {/* Video Container */}
          <video
            autoPlay
            muted
            loop
            className="absolute inset-0 z-0 object-cover w-full h-full  blur-sm"
          >
            <source src="/video.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          <h1 className="z-10 text-3xl text-center uppercase p-4 md:p-10 md:text-5xl xl:text-7xl">
